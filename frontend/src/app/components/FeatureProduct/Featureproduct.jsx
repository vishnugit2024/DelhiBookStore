...
const Featureproduct = ({ productlength = 4, btnlength = 8 }) => {
  ...
  useEffect(() => {
    ...
    const fetchNewArrivals = async () => {
      try {
 const response = await axiosInstance.get("/product/get-featured-books");        setProduct(response.data.products || []);
      } catch (err) {
          ...
          return (
            ...
            >
              ...
              <div className="w-full">
                ...
                {/* Add to Cart Button */}
                <button
                  className={isInCart ? "added-to-cart-btn" : "add-to-cart-btn"}
